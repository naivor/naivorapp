package com.naivor.android.widget.draggridview;
...
public class DynamicGridView extends GridView {
	...
	private boolean isShowWobbleAnimation = false;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (mCellIsMobile) {
				...
				Log.i("info", mHoverCellCurrentBounds.toString());
		...
		for (Long id : idList) {
			...
			if (view != null) {
				...
				if ((aboveRight(targetColumnRowPair, mobileColumnRowPair) && deltaYTotal < view.getBottom()
						...
						|| aboveLeft(targetColumnRowPair, mobileColumnRowPair) && deltaYTotal < view.getBottom()
...
//					mMobileView.setVisibility(View.INVISIBLE);
	...
	private class LSwitchCellAnimator implements SwitchCellAnimator {
		...
		public void animateSwitchCell(final int originalPosition, final int targetPosition) {
			getViewTreeObserver()
					.addOnPreDrawListener(new AnimateSwitchViewOnPreDrawListener(originalPosition, targetPosition));
		}
...
//				mMobileView.setVisibility(View.INVISIBLE);
	...
	public boolean isShowWobbleAnimation() {
		return isShowWobbleAnimation;
	}

	public void setShowWobbleAnimation(boolean isShowWobbleAnimation) {
		this.isShowWobbleAnimation = isShowWobbleAnimation;
	}
