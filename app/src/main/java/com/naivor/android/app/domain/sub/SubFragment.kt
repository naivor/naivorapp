...
import com.naivor.android.app.databinding.FragmentSubBinding
 ...
 */
@AndroidEntryPoint
class SubFragment : BaseFragment<FragmentSubBinding, BaseViewModel>() {
    override val viewModel: BaseViewModel?=null

    override val pageTitle: String="子页"

    override val inflateRootView: (ViewGroup?) -> View={
        __binding= FragmentSubBinding.inflate(layoutInflater,it,false)
        binding.root
    }
