 ...
 */
public class TwoFragment extends BaseFragment implements TwoVPContact.TwoView {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Observable.create((ObservableOnSubscribe<SimpleItem>) emmiter -> {
            emmiter.onNext(SimpleItem.builder().resId(0).content("我是 itemview ").build());
                ...
                .subscribe(objects -> adapter.setItems(objects));
